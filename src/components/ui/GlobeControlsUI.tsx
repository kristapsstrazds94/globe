...
export function GlobeControlsUI() {
  ...
  return (
    <div className="globe-controls" role="toolbar" aria-label="Globe navigation">
      <ControlButton label="Rotate left" onClick={() => invoke("rotateLeft")} />
      <ControlButton label="Rotate right" onClick={() => invoke("rotateRight")} />
      <ControlButton label="Rotate up" onClick={() => invoke("rotateUp")} />
      <ControlButton label="Rotate down" onClick={() => invoke("rotateDown")} />
